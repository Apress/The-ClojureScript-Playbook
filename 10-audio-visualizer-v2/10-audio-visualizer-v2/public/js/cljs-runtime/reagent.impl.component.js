...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__21664 = c;
var G__21664__$1 = (((G__21664 == null))?null:G__21664.prototype);
if((G__21664__$1 == null)){
return null;
} else {
return G__21664__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__21668 = c;
var G__21668__$1 = (((G__21668 == null))?null:G__21668.prototype);
if((G__21668__$1 == null)){
return null;
} else {
return G__21668__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__21725__delegate = function (args){
...
while (G__21726__i < G__21726__a.length) {G__21726__a[G__21726__i] = arguments[G__21726__i + 0]; ++G__21726__i;}
  args = new cljs.core.IndexedSeq(G__21726__a,0,null);
} 
return G__21725__delegate.call(this,args);};
G__21725.cljs$lang$maxFixedArity = 0;
G__21725.cljs$lang$applyTo = (function (arglist__21727){
var args = cljs.core.seq(arglist__21727);
return G__21725__delegate(args);
});
...
var or__5142__auto__ = (function (){var G__21678 = c;
var G__21678__$1 = (((G__21678 == null))?null:G__21678.constructor);
if((G__21678__$1 == null)){
return null;
} else {
return G__21678__$1.displayName;
}
})();
...
var G__21679 = c;
var G__21679__$1 = (((G__21679 == null))?null:G__21679.constructor);
if((G__21679__$1 == null)){
return null;
} else {
return G__21679__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__21680 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__21681 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__21681);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__21680);
}});
...
var G__21683 = reagent.impl.component.goog$module$goog$object.get(component_state,"cljsRatom");
if((G__21683 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__21683);
}
} else {
return null;
}
...
var renders_21735 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_21736 = cljs.core.first(cljs.core.vals(renders_21735));
...
if((cljs.core.count(renders_21735) > (0))){
} else {
throw (new Error((""+"Assert failed: "+"Missing reagent-render"+"\n"+"(pos? (count renders))")));
}

if(((1) === cljs.core.count(renders_21735))){
} else {
throw (new Error((""+"Assert failed: "+"Too many render functions supplied"+"\n"+"(== 1 (count renders))")));
}

if(cljs.core.ifn_QMARK_(render_fun_21736)){
} else {
throw (new Error((""+"Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1((""+"Expected something callable, not "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_21736], 0)))))+"\n"+"(clojure.core/ifn? render-fun)")));
}
...
var G__21698 = o;
reagent.impl.component.goog$module$goog$object.set(G__21698,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__21700 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__21701 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__21701);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__21700);
}});
...
var vec__21702 = module$node_modules$react$index.useReducer(cljs.core.inc,(0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21702,(0),null);
var force_update = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21702,(1),null);
