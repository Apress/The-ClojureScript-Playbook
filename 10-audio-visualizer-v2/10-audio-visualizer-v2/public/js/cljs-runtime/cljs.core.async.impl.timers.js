...
var i_14588 = (0);
while(true){
if((i_14588 < arr.length)){
(arr[i_14588] = null);

var G__14590 = (i_14588 + (1));
i_14588 = G__14590;
continue;
} else {
}
...
var i_14607 = (self__.level + (1));
while(true){
if((i_14607 <= (new_level + (1)))){
(update[i_14607] = self__.header);

var G__14608 = (i_14607 + (1));
i_14607 = G__14608;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_14609 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14609[i]));
} else {
x__$2.forward.push((((i < links_14609.length))?(links_14609[i]):null));
}

if((i < links_14609.length)){
(links_14609[i] = x__$2);
} else {
links_14609.push(x__$2);
}
...
var i_14611 = (0);
while(true){
if((i_14611 <= self__.level)){
var links_14612 = (update[i_14611]).forward;
if((x__$1 === (((i_14611 < links_14612.length))?(links_14612[i_14611]):null))){
(links_14612[i_14611] = (x__$1.forward[i_14611]));

var G__14613 = (i_14611 + (1));
i_14611 = G__14613;
continue;
} else {
var G__14614 = (i_14611 + (1));
i_14611 = G__14614;
continue;
}
} else {
...
var G__14616 = nx;
var G__14617 = (level__$1 - (1));
x = G__14616;
level__$1 = G__14617;
continue;
} else {
var G__14619 = x;
var G__14620 = (level__$1 - (1));
x = G__14619;
level__$1 = G__14620;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__14628 = nx;
var G__14629 = (level__$1 - (1));
x = G__14628;
level__$1 = G__14629;
continue;
} else {
var G__14630 = x;
var G__14631 = (level__$1 - (1));
x = G__14630;
level__$1 = G__14631;
continue;
}
