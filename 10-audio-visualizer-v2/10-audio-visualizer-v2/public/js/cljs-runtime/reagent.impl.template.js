...
var G__22043 = o;
reagent.impl.template.goog$module$goog$object.set(G__22043,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__22062__i < G__22062__a.length) {G__22062__a[G__22062__i] = arguments[G__22062__i + 0]; ++G__22062__i;}
  args = new cljs.core.IndexedSeq(G__22062__a,0,null);
} 
...
var G__22044 = o;
reagent.impl.template.goog$module$goog$object.set(G__22044,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__22045 = props;
var G__22045__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22045,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22045);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22045__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5142__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22046 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22046,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22046;
}
})(),id_class);
...
var temp__5825__auto___22067 = (function (){var and__5140__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___22067)){
var d_22068 = temp__5825__auto___22067;
if((d_22068 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_22068.s}));
} else {
...
var G__22047 = (cljs.core.count(argv) - first_child);
switch (G__22047) {
case (0):
...
var vec__22048 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22048,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22048,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22048,(2),null);
...
var temp__5829__auto___22070 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22070 == null)){
} else {
var key_22071 = temp__5829__auto___22070;
(jsprops.key = key_22071);
}
...
var temp__5829__auto___22072 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22072 == null)){
} else {
var key_22073 = temp__5829__auto___22072;
(jsprops.key = key_22073);
}
...
var temp__5829__auto___22074 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22074 == null)){
} else {
var key_22075 = temp__5829__auto___22074;
(jsprops.key = key_22075);
}
...
var temp__5829__auto___22076 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___22076 == null)){
} else {
var key_22077 = temp__5829__auto___22076;
(jsprops.key = key_22077);
}
...
var temp__5829__auto___22078 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22078 == null)){
} else {
var key_22079 = temp__5829__auto___22078;
(jsprops.key = key_22079);
}
...
var temp__5829__auto___22080 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22080 == null)){
} else {
var key_22081 = temp__5829__auto___22080;
(jsprops.key = key_22081);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22051_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22051_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22052 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22052,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22052,(1),null);
...
break;
default:
var G__22083 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22084 = compiler;
v = G__22083;
compiler = G__22084;
continue;
...
var G__22056 = tag;
var G__22056__$1 = (((G__22056 instanceof cljs.core.Keyword))?G__22056.fqn:null);
switch (G__22056__$1) {
case ">":
...
*/
reagent.impl.template.t_reagent$impl$template22058 = (function (opts,id,fn_to_element,parse_fn,meta22059){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22058.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22060,meta22059__$1){
var self__ = this;
var _22060__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22058(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22059__$1));
}));

(reagent.impl.template.t_reagent$impl$template22058.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22060){
var self__ = this;
var _22060__$1 = this;
return self__.meta22059;
}));

(reagent.impl.template.t_reagent$impl$template22058.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22058.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22058.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22058.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22058.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22058.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22059","meta22059",1599182190,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22058.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22058.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22058");

(reagent.impl.template.t_reagent$impl$template22058.cljs$lang$ctorPrWriter = (function (this__5434__auto__,writer__5435__auto__,opt__5436__auto__){
return cljs.core._write(writer__5435__auto__,"reagent.impl.template/t_reagent$impl$template22058");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22058.
 */
reagent.impl.template.__GT_t_reagent$impl$template22058 = (function reagent$impl$template$__GT_t_reagent$impl$template22058(opts,id,fn_to_element,parse_fn,meta22059){
return (new reagent.impl.template.t_reagent$impl$template22058(opts,id,fn_to_element,parse_fn,meta22059));
});
...
return (new reagent.impl.template.t_reagent$impl$template22058(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
